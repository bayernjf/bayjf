...
export default function SkillsGrid() {
  ...
  const getSkillName = (name: string) => {
    const map: Record<string, string> = {
      'Interface Design & Layout': language === 'en' ? 'Interface Design & Layout' : 'Diseño de Interfaz y Maquetación',
      'Design Systems Architecture': language === 'en' ? 'Design Systems Architecture' : 'Arquitectura de Sistemas de Diseño',
      'Motion & Spatial UI': language === 'en' ? 'Motion & Spatial UI' : 'UI Espacial y de Movimiento',
      'Glassmorphism & Aesthetics': language === 'en' ? 'Glassmorphism & Aesthetics' : 'Estética de Efecto Vidrio',
      'React / Vite Architecture': language === 'en' ? 'React / Vite Architecture' : 'Arquitectura React / Vite',
      'TypeScript Integration': language === 'en' ? 'TypeScript Integration' : 'Integración con TypeScript',
      'Tailwind CSS Mastery': language === 'en' ? 'Tailwind CSS Mastery' : 'Dominio de Tailwind CSS',
      'Framer Motion (Animations)': language === 'en' ? 'Framer Motion (Animations)' : 'Animaciones con Framer Motion',
      'WebGL & Immersive Canvas': language === 'en' ? 'WebGL & Immersive Canvas' : 'Lienzos Inmersivos y WebGL',
      'Performance Optimization': language === 'en' ? 'Performance Optimization' : 'Optimización del Rendimiento',
      'Audio & Visual Processing': language === 'en' ? 'Audio & Visual Processing' : 'Procesamiento de Audio y Video',
      'API Design & Integration': language === 'en' ? 'API Design & Integration' : 'Integración y Diseño de APIs',
