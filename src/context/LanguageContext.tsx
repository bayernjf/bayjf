...
const RAW_PROJECTS_EN: Project[] = [
  ...
  },
  {
    ...
    description: 'A gamified multi-agent orchestration workbench where every agent is a factory, tokens are the power supply, and output moves downstream by pipe and truck.',
...
const RAW_PROJECTS_ZH: Project[] = [
  ...
  },
  {
    ...
    description: '游戏化的多智能体编排工作台：每个 Agent 是一座厂房，token 是电力，产出通过管道与卡车运往下游。搭建你的智能体流水线，解锁技能卡，用 RTS 的直觉调度 AI 生产力。',
